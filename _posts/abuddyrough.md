---
layout: post
title: "Dev Log: I Made A Little Guy - Abuddy"
...
Note: This is a discussion of the original out of the box Abuddy. If you visit the repo, you'll notice there's already a v1.1 - v1.1 holds everything I'll be discussing but some might be a little different.
...
{% include browser-img.html src="/assets/img/posts/4282026/abuddycodespacerun.webp" alt="Screenshot of a codespace terminal running the abuddy pushed to the repo successfully" %}
