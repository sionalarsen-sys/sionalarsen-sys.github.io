...
tags: [shell, bash, scripting, pomodoro, tux, devlog, code, development, abuddy, badluck, studying]
author: Siona
---
...
For more about abuddy, check out my previous [Dev Log post]({% post_url 2026-04-29-abuddydev %}) or go to my [repo](https://github.com/sionalarsen-sys/accountabili-buddy/tree/main)
